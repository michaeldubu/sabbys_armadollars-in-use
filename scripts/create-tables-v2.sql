...
VALUES 
  ('Sabrina Wofford', 'admin@armadollars.app', 'admin', 100000, 500, '555-123-4567', 'Michael Wofford', '555-987-6543'),
  ('Vicktoria Jergenson', 'vicktoria@armadollars.app', 'manager', 75, 3, '555-234-5678', 'Emergency Contact', '555-876-5432'),
  ('Test Admin', 'test@armadollars.app', 'admin', 150, 7, '555-345-6789', 'Test Contact', '555-765-4321'),
  ('Alice Williams', 'alice@armadollars.app', 'server', 200, 10, '555-456-7890', 'Alice Emergency', '555-654-3210');
...
SELECT 'Employee names:' as info, string_agg(name, ', ') as names FROM employees;
